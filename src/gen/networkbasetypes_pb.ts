...
import { file_network_connection } from "./network_connection_pb.ts";
 ...
 */
export const CMsgVectorSchema: GenMessage<CMsgVector, {jsonType: CMsgVectorJson}> = /*@__PURE__*/
 ...
 */
export const CMsgVector2DSchema: GenMessage<CMsgVector2D, {jsonType: CMsgVector2DJson}> = /*@__PURE__*/
 ...
 */
export const CMsgQAngleSchema: GenMessage<CMsgQAngle, {jsonType: CMsgQAngleJson}> = /*@__PURE__*/
 ...
 * @generated from message CMsgQuaternion
 */
export type CMsgQuaternionJson = {
  /**
   * @generated from field: optional float x = 1;
   */
  x?: number | "NaN" | "Infinity" | "-Infinity";
 ...
 */
export const CMsgQuaternionSchema: GenMessage<CMsgQuaternion, {jsonType: CMsgQuaternionJson}> = /*@__PURE__*/
 ...
 */
export const CMsgTransformSchema: GenMessage<CMsgTransform, {jsonType: CMsgTransformJson}> = /*@__PURE__*/
 ...
 */
export const CMsgRGBASchema: GenMessage<CMsgRGBA, {jsonType: CMsgRGBAJson}> = /*@__PURE__*/
 ...
 * @generated from message CMsgPlayerInfo
 */
export type CMsgPlayerInfoJson = {
  /**
   * @generated from field: optional string name = 1;
   */
  name?: string;
 ...
 */
export const CMsgPlayerInfoSchema: GenMessage<CMsgPlayerInfo, {jsonType: CMsgPlayerInfoJson}> = /*@__PURE__*/
 ...
 */
export const CEntityMsgSchema: GenMessage<CEntityMsg, {jsonType: CEntityMsgJson}> = /*@__PURE__*/
 ...
 * @generated from message CMsg_CVars
 */
export type CMsg_CVarsJson = {
  /**
   * @generated from field: repeated CMsg_CVars.CVar cvars = 1;
   */
  cvars?: CMsg_CVars_CVarJson[];
};
 ...
 */
export const CMsg_CVarsSchema: GenMessage<CMsg_CVars, {jsonType: CMsg_CVarsJson}> = /*@__PURE__*/
 ...
 * @generated from message CMsg_CVars.CVar
 */
export type CMsg_CVars_CVarJson = {
  /**
   * @generated from field: optional string name = 1;
   */
  name?: string;
 ...
 */
export const CMsg_CVars_CVarSchema: GenMessage<CMsg_CVars_CVar, {jsonType: CMsg_CVars_CVarJson}> = /*@__PURE__*/
 ...
 */
export const CNETMsg_NOPSchema: GenMessage<CNETMsg_NOP, {jsonType: CNETMsg_NOPJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SplitScreenUser
 */
export type CNETMsg_SplitScreenUserJson = {
  /**
   * @generated from field: optional int32 slot = 1;
   */
  slot?: number;
 ...
 */
export const CNETMsg_SplitScreenUserSchema: GenMessage<CNETMsg_SplitScreenUser, {jsonType: CNETMsg_SplitScreenUserJson}> = /*@__PURE__*/
 ...
 */
export const CNETMsg_TickSchema: GenMessage<CNETMsg_Tick, {jsonType: CNETMsg_TickJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_StringCmd
 */
export type CNETMsg_StringCmdJson = {
  /**
   * @generated from field: optional string command = 1;
   */
  command?: string;
 ...
 */
export const CNETMsg_StringCmdSchema: GenMessage<CNETMsg_StringCmd, {jsonType: CNETMsg_StringCmdJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SetConVar
 */
export type CNETMsg_SetConVarJson = {
  /**
   * @generated from field: optional CMsg_CVars convars = 1;
   */
  convars?: CMsg_CVarsJson;
};
 ...
 */
export const CNETMsg_SetConVarSchema: GenMessage<CNETMsg_SetConVar, {jsonType: CNETMsg_SetConVarJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SignonState
 */
export type CNETMsg_SignonStateJson = {
  /**
   * @generated from field: optional SignonState_t signon_state = 1 [default = SIGNONSTATE_NONE];
   */
  signonState?: SignonState_tJson;
 ...
 */
export const CNETMsg_SignonStateSchema: GenMessage<CNETMsg_SignonState, {jsonType: CNETMsg_SignonStateJson}> = /*@__PURE__*/
 ...
 * @generated from message CSVCMsg_GameEvent
 */
export type CSVCMsg_GameEventJson = {
  /**
   * @generated from field: optional string event_name = 1;
   */
  eventName?: string;
   ...
   * @generated from field: repeated CSVCMsg_GameEvent.key_t keys = 3;
   */
  keys?: CSVCMsg_GameEvent_key_tJson[];
};
 ...
 */
export const CSVCMsg_GameEventSchema: GenMessage<CSVCMsg_GameEvent, {jsonType: CSVCMsg_GameEventJson}> = /*@__PURE__*/
 ...
 * @generated from message CSVCMsg_GameEvent.key_t
 */
export type CSVCMsg_GameEvent_key_tJson = {
  /**
   * @generated from field: optional int32 type = 1;
   */
  type?: number;
   ...
   * @generated from field: optional float val_float = 3;
   */
  valFloat?: number | "NaN" | "Infinity" | "-Infinity";
 ...
 */
export const CSVCMsg_GameEvent_key_tSchema: GenMessage<CSVCMsg_GameEvent_key_t, {jsonType: CSVCMsg_GameEvent_key_tJson}> = /*@__PURE__*/
 ...
 * @generated from message CSVCMsgList_GameEvents
 */
export type CSVCMsgList_GameEventsJson = {
  /**
   * @generated from field: repeated CSVCMsgList_GameEvents.event_t events = 1;
   */
  events?: CSVCMsgList_GameEvents_event_tJson[];
};
 ...
 */
export const CSVCMsgList_GameEventsSchema: GenMessage<CSVCMsgList_GameEvents, {jsonType: CSVCMsgList_GameEventsJson}> = /*@__PURE__*/
 ...
 * @generated from message CSVCMsgList_GameEvents.event_t
 */
export type CSVCMsgList_GameEvents_event_tJson = {
  /**
   * @generated from field: optional int32 tick = 1;
   */
  tick?: number;
 ...
 */
export const CSVCMsgList_GameEvents_event_tSchema: GenMessage<CSVCMsgList_GameEvents_event_t, {jsonType: CSVCMsgList_GameEvents_event_tJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SpawnGroup_Load
 */
export type CNETMsg_SpawnGroup_LoadJson = {
  /**
   * @generated from field: optional string worldname = 1;
   */
  worldname?: string;
   ...
   * @generated from field: optional CMsgVector world_offset_pos = 6;
   */
  worldOffsetPos?: CMsgVectorJson;

  /**
   * @generated from field: optional CMsgQAngle world_offset_angle = 7;
   */
  worldOffsetAngle?: CMsgQAngleJson;
 ...
 */
export const CNETMsg_SpawnGroup_LoadSchema: GenMessage<CNETMsg_SpawnGroup_Load, {jsonType: CNETMsg_SpawnGroup_LoadJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SpawnGroup_ManifestUpdate
 */
export type CNETMsg_SpawnGroup_ManifestUpdateJson = {
  /**
   * @generated from field: optional uint32 spawngrouphandle = 1;
   */
  spawngrouphandle?: number;
 ...
 */
export const CNETMsg_SpawnGroup_ManifestUpdateSchema: GenMessage<CNETMsg_SpawnGroup_ManifestUpdate, {jsonType: CNETMsg_SpawnGroup_ManifestUpdateJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SpawnGroup_SetCreationTick
 */
export type CNETMsg_SpawnGroup_SetCreationTickJson = {
  /**
   * @generated from field: optional uint32 spawngrouphandle = 1;
   */
  spawngrouphandle?: number;
 ...
 */
export const CNETMsg_SpawnGroup_SetCreationTickSchema: GenMessage<CNETMsg_SpawnGroup_SetCreationTick, {jsonType: CNETMsg_SpawnGroup_SetCreationTickJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SpawnGroup_Unload
 */
export type CNETMsg_SpawnGroup_UnloadJson = {
  /**
   * @generated from field: optional uint32 spawngrouphandle = 1;
   */
  spawngrouphandle?: number;
 ...
 */
export const CNETMsg_SpawnGroup_UnloadSchema: GenMessage<CNETMsg_SpawnGroup_Unload, {jsonType: CNETMsg_SpawnGroup_UnloadJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_SpawnGroup_LoadCompleted
 */
export type CNETMsg_SpawnGroup_LoadCompletedJson = {
  /**
   * @generated from field: optional uint32 spawngrouphandle = 1;
   */
  spawngrouphandle?: number;
 ...
 */
export const CNETMsg_SpawnGroup_LoadCompletedSchema: GenMessage<CNETMsg_SpawnGroup_LoadCompleted, {jsonType: CNETMsg_SpawnGroup_LoadCompletedJson}> = /*@__PURE__*/
 ...
 * @generated from message CSVCMsg_GameSessionConfiguration
 */
export type CSVCMsg_GameSessionConfigurationJson = {
  /**
   * @generated from field: optional bool is_multiplayer = 1;
   */
  isMultiplayer?: boolean;
 ...
 */
export const CSVCMsg_GameSessionConfigurationSchema: GenMessage<CSVCMsg_GameSessionConfiguration, {jsonType: CSVCMsg_GameSessionConfigurationJson}> = /*@__PURE__*/
 ...
 * @generated from message CNETMsg_DebugOverlay
 */
export type CNETMsg_DebugOverlayJson = {
  /**
   * @generated from field: optional int32 etype = 1;
   */
  etype?: number;
   ...
   * @generated from field: repeated float dimensions = 4;
   */
  dimensions?: (number | "NaN" | "Infinity" | "-Infinity")[];

  /**
   * @generated from field: repeated float times = 5;
   */
  times?: (number | "NaN" | "Infinity" | "-Infinity")[];
 ...
 */
export const CNETMsg_DebugOverlaySchema: GenMessage<CNETMsg_DebugOverlay, {jsonType: CNETMsg_DebugOverlayJson}> = /*@__PURE__*/
 ...
 * @generated from enum SignonState_t
 */
export type SignonState_tJson = "SIGNONSTATE_NONE" | "SIGNONSTATE_CHALLENGE" | "SIGNONSTATE_CONNECTED" | "SIGNONSTATE_NEW" | "SIGNONSTATE_PRESPAWN" | "SIGNONSTATE_SPAWN" | "SIGNONSTATE_FULL" | "SIGNONSTATE_CHANGELEVEL";

/**
 * Describes the enum SignonState_t.
 */
export const SignonState_tSchema: GenEnum<SignonState_t, SignonState_tJson> = /*@__PURE__*/
 ...
 * @generated from enum NET_Messages
 */
export type NET_MessagesJson = "net_NOP" | "net_Disconnect_Legacy" | "net_SplitScreenUser" | "net_Tick" | "net_StringCmd" | "net_SetConVar" | "net_SignonState" | "net_SpawnGroup_Load" | "net_SpawnGroup_ManifestUpdate" | "net_SpawnGroup_SetCreationTick" | "net_SpawnGroup_Unload" | "net_SpawnGroup_LoadCompleted" | "net_DebugOverlay";

/**
 * Describes the enum NET_Messages.
 */
export const NET_MessagesSchema: GenEnum<NET_Messages, NET_MessagesJson> = /*@__PURE__*/
 ...
 * @generated from enum SpawnGroupFlags_t
 */
export type SpawnGroupFlags_tJson = "SPAWN_GROUP_LOAD_ENTITIES_FROM_SAVE" | "SPAWN_GROUP_DONT_SPAWN_ENTITIES" | "SPAWN_GROUP_SYNCHRONOUS_SPAWN" | "SPAWN_GROUP_IS_INITIAL_SPAWN_GROUP" | "SPAWN_GROUP_CREATE_CLIENT_ONLY_ENTITIES" | "SPAWN_GROUP_BLOCK_UNTIL_LOADED" | "SPAWN_GROUP_LOAD_STREAMING_DATA" | "SPAWN_GROUP_CREATE_NEW_SCENE_WORLD";

/**
 * Describes the enum SpawnGroupFlags_t.
 */
export const SpawnGroupFlags_tSchema: GenEnum<SpawnGroupFlags_t, SpawnGroupFlags_tJson> = /*@__PURE__*/
