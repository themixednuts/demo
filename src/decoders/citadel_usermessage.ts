...
} from "@/gen/citadel_usermessages_pb";
...
export interface CitadelUserMessageDecoderReturnType {
  ...
  [CitadelUserMessageIds.k_EUserMsg_TriggerDamageFlash]: CCitadelUserMsg_TriggerDamageFlash;
  [CitadelUserMessageIds.k_EUserMsg_AbilitiesChanged]: CCitadelUserMsg_AbilitiesChanged;
  [CitadelUserMessageIds.k_EUserMsg_RecentDamageSummary]: CCitadelUserMsg_RecentDamageSummary;
  [CitadelUserMessageIds.k_EUserMsg_SpectatorTeamChanged]: CCitadelUserMsg_SpectatorTeamChanged;
  ...
  [CitadelUserMessageIds.k_EUserMsg_QuickResponse]: CCitadelUserMsg_QuickResponse;
  [CitadelUserMessageIds.k_EUserMsg_PostMatchDetails]: CCitadelUserMsg_PostMatchDetails;
  [CitadelUserMessageIds.k_EUserMsg_ChatEvent]: CCitadelUserMsg_ChatEvent;
  [CitadelUserMessageIds.k_EUserMsg_AbilityInterrupted]: CCitadelUserMsg_AbilityInterrupted;
  ...
  [CitadelUserMessageIds.k_EUserMsg_SetClientCameraAngles]: CCitadelUserMsg_SetClientCameraAngles;
  ...
  [CitadelUserMessageIds.k_EUserMsg_ObjectiveMask]: CCitadelUserMessage_ObjectiveMask;
  [CitadelUserMessageIds.k_EUserMsg_ModifierApplied]: CCitadelUserMessage_ModifierApplied;
  [CitadelUserMessageIds.k_EUserMsg_CameraController]: CCitadelUserMsg_CameraController;
  [CitadelUserMessageIds.k_EUserMsg_AuraModifierApplied]: CCitadelUserMessage_AuraModifierApplied;
  [CitadelUserMessageIds.k_EUserMsg_ObstructedShotFired]: CCitadelUserMsg_ObstructedShotFired;
  [CitadelUserMessageIds.k_EUserMsg_AbilityLateFailure]: CCitadelUserMsg_AbilityLateFailure;
  [CitadelUserMessageIds.k_EUserMsg_AbilityPing]: CCitadelUserMsg_AbilityPing;
  [CitadelUserMessageIds.k_EUserMsg_PostProcessingAnim]: CCitadelUserMsg_PostProcessingAnim;
  [CitadelUserMessageIds.k_EUserMsg_DeathReplayData]: CCitadelUserMsg_DeathReplayData;
  [CitadelUserMessageIds.k_EUserMsg_PlayerLifetimeStatInfo]: CCitadelUserMsg_PlayerLifetimeStatInfo;
  [CitadelUserMessageIds.k_EUserMsg_ForceShopClosed]: CCitadelUserMsg_ForceShopClosed;
  [CitadelUserMessageIds.k_EUserMsg_StaminaDrained]: CCitadelUserMsg_StaminaDrained;
  [CitadelUserMessageIds.k_EUserMsg_AbilityNotify]: CCitadelUserMessage_AbilityNotify;
  [CitadelUserMessageIds.k_EUserMsg_GetDamageStatsResponse]: CCitadelUserMsg_GetDamageStatsResponse;
  [CitadelUserMessageIds.k_EUserMsg_ParticipantStartSoundEvent]: CCitadelUserMsg_ParticipantStartSoundEvent;
  [CitadelUserMessageIds.k_EUserMsg_ParticipantStopSoundEvent]: CCitadelUserMsg_ParticipantStopSoundEvent;
  [CitadelUserMessageIds.k_EUserMsg_ParticipantStopSoundEventHash]: CCitadelUserMsg_ParticipantStopSoundEventHash;
  [CitadelUserMessageIds.k_EUserMsg_ParticipantSetSoundEventParams]: CCitadelUserMsg_ParticipantSetSoundEventParams;
  [CitadelUserMessageIds.k_EUserMsg_ParticipantSetLibraryStackFields]: CCitadelUserMsg_ParticipantSetLibraryStackFields;
  [CitadelUserMessageIds.k_EUserMsg_CurrencyChanged]: CCitadelUserMessage_CurrencyChanged;
  ...
  [CitadelUserMessageIds.k_EUserMsg_MidBossSpawned]: CCitadelUserMsg_MidBossSpawned;
  ...
  [CitadelUserMessageIds.k_EUserMsg_PlayerRespawned]: CCitadelUserMsg_PlayerRespawned;
  [CitadelUserMessageIds.k_EUserMsg_CallCheaterVote]: CCitadelUserMsg_CallCheaterVote;
  [CitadelUserMessageIds.k_EUserMsg_MeleeHit]: CCitadelUserMessage_MeleeHit;
  [CitadelUserMessageIds.k_EUserMsg_FlexSlotUnlocked]: CCitadelUserMsg_FlexSlotUnlocked;
  [CitadelUserMessageIds.k_EUserMsg_SeasonalAchievementUnlocked]: CCitadelUserMsg_SeasonalAchievementUnlocked;
  [CitadelUserMessageIds.k_EUserMsg_MusicQueue]: CCitadelUserMsg_MusicQueue;
  [CitadelUserMessageIds.k_EUserMsg_AG2ParamTrigger]: CCitadelUserMsg_AG2ParamTrigger;
}

export type CitadelUserMessageDecodeMapper = {
  [K in CitadelUserMessageIds]: (
    data: Uint8Array,
...
export function decode<K extends CitadelUserMessageIds>(
  cmd: K,
  data: Uint8Array,
): CitadelUserMessageDecoderReturnType[K] {
...
export const registry: MessageTypeRegistry<
  [typeof CitadelUserMessageIds],
  CitadelUserMessageIds,
  CitadelUserMessageDecoderReturnType
> = {
  enums: [CitadelUserMessageIds],
