...
type AllNetMessages = CLC_Messages | SVC_Messages | Bidirectional_Messages;
...
export interface DecoderReturnType {
  ...
  [Bidirectional_Messages.bi_RebroadcastGameEvent]: CBidirMsg_RebroadcastGameEvent;
