...
export interface DecoderReturnType {
  ...
  [EBaseUserMessages.UM_ExtraUserData]: CUserMessage_ExtraUserData;
  [EBaseUserMessages.UM_NotifyResponseFound]: CUserMessage_NotifyResponseFound;
...
export const UserMessageDecoder: DecodeMapper = {
  ...
  [EBaseUserMessages.UM_DiagnosticResponse]: (data: Uint8Array) =>
    fromBinary(CUserMessage_Diagnostic_ResponseSchema, data),
  [EBaseUserMessages.UM_ExtraUserData]: (data: Uint8Array) =>
    fromBinary(CUserMessage_ExtraUserDataSchema, data),
  [EBaseUserMessages.UM_NotifyResponseFound]: (data: Uint8Array) =>
