...
export interface DecoderReturnType {
  ...
  [EDemoCommands.DEM_Packet]: CDemoPacket;
  [EDemoCommands.DEM_SignonPacket]: CDemoPacket;
  ...
  [EDemoCommands.DEM_SpawnGroups]: CDemoSpawnGroups;
...
export const DEMDecoder: DecodeMapper = {
  ...
  [EDemoCommands.DEM_Packet]: (data: Uint8Array) =>
    fromBinary(CDemoPacketSchema, data),
  [EDemoCommands.DEM_SignonPacket]: (data: Uint8Array) =>
    fromBinary(CDemoPacketSchema, data),
  ...
  [EDemoCommands.DEM_SpawnGroups]: (data: Uint8Array) =>
    fromBinary(CDemoSpawnGroupsSchema, data),
