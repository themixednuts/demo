...
import netmessage_base from "@/decoders/netmessage.base";
import netmessage from "@/decoders/netmessage";
import usermessage from "@/decoders/usermessage";
import citadel_gameevent from "@/decoders/citadel_gameevent";
import citadel_usermessage from "@/decoders/citadel_usermessage";
import temp_entity from "@/decoders/temp_entity";
import game_event from "@/decoders/gameevent";
...
export class DemoPacket {
  ...
  public static from(bitbuffer: BitBuffer) {
